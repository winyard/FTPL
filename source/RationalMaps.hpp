    ...
    vector<double> rationalMap(double thi, double theta, int B)
    {
        ...
        switch (B)
        {
            ...
            case 32:
                ...
                reala = pow(tan(thi/2.0),2)*(a321r*cos(2.0*theta) - a321i*sin(2.0*theta)) + pow(tan(thi/2.0),7)*(a322r*cos(7.0*theta) - a322i*sin(7.0*theta)) + pow(tan(thi/2.0),12)*(a323r*cos(12.0*theta) - a323i*sin(12.0*theta)) + pow(tan(thi/2.0),17)*(a324r*cos(17.0*theta) - a324i*sin(17.0*theta)) + pow(tan(thi/2.0),22)*(a325r*cos(22.0*theta) - a325i*sin(22.0*theta)) + pow(tan(thi/2.0),27)*(a326r*cos(27.0*theta) - a326i*sin(27.0*theta)) + pow(tan(thi/2.0),32)*cos(32.0*theta);
                ima = pow(tan(thi/2.0),2)*(a321r*sin(2.0*theta) + a321i*cos(2.0*theta)) + pow(tan(thi/2.0),7)*(a322r*sin(7.0*theta) + a322i*cos(7.0*theta)) + pow(tan(thi/2.0),12)*(a323r*sin(12.0*theta) + a323i*cos(12.0*theta)) + pow(tan(thi/2.0),17)*(a324r*sin(17.0*theta) + a324i*cos(17.0*theta)) + pow(tan(thi/2.0),22)*(a325r*sin(22.0*theta) + a325i*cos(22.0*theta)) + pow(tan(thi/2.0),27)*(a326r*sin(27.0*theta) + a326i*cos(27.0*theta)) + pow(tan(thi/2.0),32)*sin(32.0*theta);
                realb = 1.0 + pow(tan(thi/2.0),5)*(a326r*cos(5.0*theta) - a326i*sin(5.0*theta)) + pow(tan(thi/2.0),10)*(a325r*cos(10.0*theta) - a325i*sin(10.0*theta)) + pow(tan(thi/2.0),15)*(a324r*cos(15.0*theta) - a324i*sin(15.0*theta)) + pow(tan(thi/2.0),20)*(a323r*cos(20.0*theta) - a323i*sin(20.0*theta)) + pow(tan(thi/2.0),25)*(a322r*cos(25.0*theta) - a322i*sin(25.0*theta)) + pow(tan(thi/2.0),30)*(a321r*cos(30.0*theta) - a321i*sin(30.0*theta));
                imb = pow(tan(thi/2.0),5)*(a326r*sin(5.0*theta) + a326i*cos(5.0*theta)) + pow(tan(thi/2.0),10)*(a325r*sin(10.0*theta) + a325i*cos(10.0*theta)) + pow(tan(thi/2.0),15)*(a324r*sin(15.0*theta) + a324i*cos(15.0*theta)) + pow(tan(thi/2.0),20)*(a323r*sin(20.0*theta) + a323i*cos(20.0*theta)) + pow(tan(thi/2.0),25)*(a322r*sin(25.0*theta) + a322i*cos(25.0*theta)) + pow(tan(thi/2.0),30)*(a321r*sin(30.0*theta) + a321i*cos(30.0*theta));

                break;
                else{cout << "ERROR!! Requested rational map charge for the function rationalMap for charge " << B << "is unknown, please add the conversion function\n";};
        }
        if(realb==0 & imb==0)
        {
